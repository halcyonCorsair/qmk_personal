...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WINMGMT] = LAYOUT_moonlander(
        ...
        _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______,           _______, DIVVY_H, DIVVY_J, DIVVY_K,     DIVVY_L,   DIVVY_SCLN, _______,
        _______, _______, _______, _______, _______, _______,                             _______, DIVVY_M, DIVVY_COMMA, DIVVY_DOT, _______,    _______,
        _______, _______, _______, _______, _______,          _______,           _______,          _______, _______,     _______,   _______,   ii _______,
                                            _______, _______, _______,           _______, _______, _______
    ),
    ...
    [_ADJUST] = LAYOUT_moonlander(
        ...
        _______, _______, _______,   QWERTY,  _______, _______, _______,           _______, _______, _______, _______, RGB_TOG,  _______, _______,

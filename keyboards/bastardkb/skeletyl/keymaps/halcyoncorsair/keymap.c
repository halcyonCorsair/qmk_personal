 ...
 */
    [_ADJUST] = LAYOUT_split_3x5_3(
        QK_BOOT, _______, _______, _______, _______,                       _______, _______, EE_CLR, _______, QK_BOOT,
        _______, _______, COLEMAK, _______, _______,                       RGB_TOG, RGB_SAI, RGB_HUI, RGB_VAI, RGB_MOD,
        EE_CLR, _______, _______, _______, _______,                       _______, RGB_SAD, RGB_HUD, RGB_VAD, RGB_RMOD,
